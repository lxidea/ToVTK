...
protected:
  ...
  void ReindexData(unsigned sreindex,const unsigned *reindex,unsigned ndata,tuint8   *data,tuint8   *aux)const{ TReindexData<tuint8>  (sreindex,reindex,ndata,data,aux); }
...
public:
  ...
  unsigned AddArray(std::string fullname,unsigned count,const tuint8   *ptr,bool delptr=false){ return(AddArray(fullname,TypeUint8  ,count,(void*)ptr,delptr)); }
  ...
  unsigned CreateArrayUint8  (std::string fullname,unsigned count,tuint8   value=TUint8(0)  ,bool delptr=true){ return(AddArray(fullname,count,NewArrayUint8  (count,true,value),delptr)); }
  ...
  tuint8*   CreateArrayPtrUint8  (std::string fullname,unsigned count,tuint8   value=TUint8(0)  ,bool delptr=true){ return((tuint8*)  GetArrayUint8  (CreateArrayUint8  (fullname,count,value,delptr))); }
  ...
  const tuint8*   GetArrayUint8  (unsigned idx,unsigned count=0)const{ return((tuint8*  )GetArrayPtr(idx,TypeUint8  ,count)); }
  ...
  const tuint8*   GetArrayUint8  (const std::string &keyname,unsigned count=0)const{ return((tuint8*  )GetArrayPtr(keyname,TypeUint8  ,count)); }
...
public:
  ...
  static tuint8*   NewArrayUint8  (unsigned count,bool defvalue=false,tuint8   value=TUint8(0));
