...
///Structure of 8 variables of type uint.
typedef struct{
...
inline tuint8 TUint8(unsigned v){ tuint8 p={v,v,v,v,v,v,v,v}; return(p); }
inline tuint8 TUint8(unsigned i,unsigned j,unsigned k,unsigned l,unsigned m,unsigned n,unsigned o,unsigned q){ tuint8 p={i,j,k,l,m,n,o,q}; return(p); }
inline bool operator ==(const tuint8& a, const tuint8& b){ return(a.i==b.i&&a.j==b.j&&a.k==b.k&&a.l==b.l&&a.m==b.m&&a.n==b.n&&a.o==b.o&&a.p==b.p); }
inline bool operator !=(const tuint8& a, const tuint8& b){ return(a.i!=b.i||a.j!=b.j||a.k!=b.k||a.l!=b.l||a.m!=b.m||a.n!=b.n||a.o!=b.o||a.p!=b.p); }

inline ttuint8 TTUint8(unsigned v){ ttuint8 p={v,v,v,v,v,v,v,v}; return(p); }
inline ttuint8 TTUint8(unsigned i,unsigned j,unsigned k,unsigned l,unsigned m,unsigned n,unsigned o,unsigned q){ ttuint8 p={i,j,k,l,m,n,o,q}; return(p); }

inline tuint8 ReorderCellUint8(const tuint8& v){return TUint8(v.i,v.j,v.l,v.k,v.m,v.n,v.p,v.o); }
inline ttuint8 ReorderCellTUint8(const tuint8& v){return TTUint8(v.i,v.j,v.l,v.k,v.m,v.n,v.p,v.o); }
inline ttuint8 ReorderCellTUint8(const ttuint8& v){return TTUint8(v.id[0],v.id[1],v.id[2],v.id[3],v.id[4],v.id[5],v.id[6],v.id[7]); }
...
inline unsigned SizeOfType(TpTypeData type){
  switch(type){
    ...
    case TypeUint8:      return(sizeof(tuint8));
  }
  return(0);
}
